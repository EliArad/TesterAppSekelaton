...
namespace MACButtonLib
{
	...
	public class MACButton : System.Windows.Forms.Control
	{
		...
		/// to 'UserDefinedÅf value. If you set ColorStyleDisabled to another value, that will overrides 
		...
		/// to 'UserDefinedÅf value. If you set ColorStyleHover to another value, that will overrides 
		/// this property's value.
		/// </remarks>
		...
		/// to 'UserDefinedÅf value. If you set ColorStyleNormal to another value, that will overrides 
		/// this property's value.
		/// </remarks>
		...
		/// to 'UserDefinedÅf value. If you set ColorStyleDefault to another value, that will overrides 
		/// this property's value.
		/// </remarks>
		...
		/// </para>
		/// <para>
		/// Please read the section ÅeAlignment of Text and Image on ButtonÅffor detail.
		/// </para>
		/// </remarks>
